  ...
  const handleRegisterSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result.success) {
        ...
        setRegisterMessage(result.message || 'Cadastro realizado! Verifique seu email para confirmar a conta e aguarde a aprovação do administrador.');
      } else {
        setRegisterStatus('error');
              ...
              <div className="mb-5">
                ...
                <div className="relative group">
                  ...
                  <input
                    type="text"
                    value={loginEmail}
                    onChange={(e) => handleInput(setLoginEmail, e.target.value)}
          ...
          <div className="animate-in fade-in slide-in-from-right-4 duration-300">
             ...
             {forgotStatus === 'success' ? (
               ...
               <form onSubmit={handleForgotSubmit}>
                 <div className="mb-6">
                    <label className="block text-[13px] font-semibold text-slate-700 dark:text-slate-300 mb-2">Email Cadastrado</label>
                    <div className="relative group">
                      <div className="absolute left-[15px] top-1/2 -translate-y-1/2 text-slate-400 group-focus-within:text-royal-600 transition-colors">
                        <User className="h-4 w-4" />
                      </div>
